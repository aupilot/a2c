...
class MinitaurKirEnv(gym.Env):
    ...
    def _step(self, action):
        ...
        if self._is_render:
            ...
            yaw = camInfo[8]
            pitch = camInfo[9]
            targetPos = [0.95 * curTargetPos[0] + 0.05 * base_pos[0], 0.95 * curTargetPos[1] + 0.05 * base_pos[1],
                         curTargetPos[2]]
        ...
        #==kir
        # increase penalty if the action has significant change
        self._jerky_penalty = np.sum(np.abs(self._prev_action - action)) / self._action_dimention
        # decay penalty
        # self._jerky_penalty = self._jerky_penalty * self._jerky_decay
        #
    ...
    def _reward(self):
        ...
        no_jerky_reward = -self._jerky_penalty
        ...
        reward = (
                ...
                self._jerky_weight * no_jerky_reward +
